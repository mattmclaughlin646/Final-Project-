...
Partial Class searchUpdatePrescription
    ...
    Public Sub lbtnEdit_Clicks(ByVal sender As Object, ByVal e As CommandEventArgs)
        ...
        Try
            ...
            sb.Append("window.open('editRX.aspx?ID=" + Encrypt(recordToBeEdited.ToString) + "&type=Edit" + "'  , 'patient',")
