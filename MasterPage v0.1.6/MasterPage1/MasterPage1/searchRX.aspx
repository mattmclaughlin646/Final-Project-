<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="searchRX.aspx.vb" Inherits="searchRX" %>
...
<%--                 <CC1:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" ServiceMethod="SearchNameInRX" TargetControlID="txtPatlname" UseContextKey="true" CompletionInterval="1" EnableCaching="true" CompletionSetCount="12" MinimumPrefixLength="1" DelimiterCharacters=";, :" ></CC1:AutoCompleteExtender>--%>
        ...
        <asp:Label ID="hidStudID" runat="server" Text='<%#Eval("RXNUM") %>' Visible="false"></asp:Label>
                        ...
                        <asp:BoundField DataField="PATIENTFNAME" HeaderText="Patient First Name" />
                        <asp:BoundField DataField="PATIENTLNAME" HeaderText="Patient Last Name" />
